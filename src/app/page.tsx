...
export default function MercadoTurboApp() {
  const [accounts, setAccounts] = useState<MercadoLivreAccount[]>([
    {
      ...
      accessToken: 'APP_USR-1234567890-123456-abcdef1234567890'
    },
    {
      id: '2',
      nickname: 'loja_premium',
      ...
      accessToken: 'APP_USR-0987654321-654321-fedcba0987654321'
    },
    {
      id: '3',
      nickname: 'mega_store',
  ...
  const handleAccountImport = (newAccount: MercadoLivreAccount, newProducts: Product[]) => {
    // Verificar se a conta já existe (por nickname ou userId)
    ...
    if (existingAccountIndex >= 0) {
      ...
      updatedAccounts[existingAccountIndex] = {
        ...updatedAccounts[existingAccountIndex],
        ...newAccount,
        id: updatedAccounts[existingAccountIndex].id // Manter ID local
      }
    ...
    // Remover produtos antigos da mesma conta e adicionar novos
